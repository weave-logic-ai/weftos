...
// 12 MHz pixel clock — 12_000_000 Hz / (800+128) / (480+45) ≈ 24 Hz
// refresh, deliberately conservative; bump after stability is proven.
pub const LCD_PCLK_FREQ_HZ: u32 = 12_000_000;
